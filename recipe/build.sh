...
cmake -G "Ninja" \
 ...
 -D CGAL_INCLUDE_DIR:FILEPATH="$PREFIX/Library/include" \
 -D GMP_INCLUDE_DIR:FILEPATH="$PREFIX/Library/include" \
 -D MPFR_INCLUDE_DIR:FILEPATH="$PREFIX/Library/include" \
 -D CGAL_LIBRARY_DIR:FILEPATH="$PREFIX/Library/lib" \
 -D GMP_LIBRARY_DIR:FILEPATH="$PREFIX/Library/lib" \
 -D MPFR_LIBRARY_DIR:FILEPATH="$PREFIX/Library/lib" \
 ../cmake
